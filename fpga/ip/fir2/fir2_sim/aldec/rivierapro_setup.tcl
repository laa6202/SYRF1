...
# ACDS 16.1 196 win32 2018.06.30.10:30:45
# ----------------------------------------
...
# ----------------------------------------
# If fir2 is one of several IP cores in your
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/fir2_rtl_core.vhd"                              
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/fir2_ast.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/fir2.vhd"                                       
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS       "$QSYS_SIMDIR/fir2_tb.vhd"                                    
}
