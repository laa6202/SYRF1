...
# ----------------------------------------
# If fir1 is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.1 196 win32 2018.06.30.10:09:55
...
alias com {
  ...
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir1_rtl_core.vhd"                              
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir1_ast.vhd"                                   
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir1.vhd"                                       
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/fir1_tb.vhd"                                    
}
